...
>(({ className, ...props }, ref) => (
  <SheetPrimitive.Overlay
    className={cn(
      "fixed inset-0 z-50 bg-black/70 data-[state=open]:animate-in data-[state=closed]:animate-out data-[state=closed]:fade-out-0 data-[state=open]:fade-in-0 duration-[var(--nx-motion-fast)]",
      className,
    )}
    {...props}
    ref={ref}
...
const sheetVariants = cva(
  "fixed z-50 gap-4 bg-background p-6 shadow-lg transition ease-[var(--nx-motion-ease)] data-[state=closed]:duration-[var(--nx-motion-sheet-out)] data-[state=open]:duration-[var(--nx-motion-sheet)] data-[state=open]:animate-in data-[state=closed]:animate-out",
  {
    variants: {
      side: {
        ...
        /** Logical start edge (flips in RTL) */
        start:
        ...
        /** @deprecated Prefer start — aliases start for RTL-safe panels */
        ...
        /** @deprecated Prefer end — aliases end for RTL-safe panels */
        right:
