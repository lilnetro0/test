-- Phase 4: notification helper + triggers for friends, DMs, and @mentions.
...
-- DM message → notify other participants
...
-- Channel message @mentions → notify mentioned users (hub members)
...
begin
  ...
  loop
    ...
    -- Only notify if they are a hub member
