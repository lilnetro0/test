...
expected_functions(name) as (
  values
    ...
    ('tg_set_body_search_norm'),
    ('tg_hubs_sync_has_lfg'),
    ('tg_set_hub_name_search_norm'),
    ('tg_set_game_name_search_norm'),
    ('tg_set_profile_search_norm')
),
function_check as (
  select
    e.name as object_name,
